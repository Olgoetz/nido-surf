const Datenschutz = () => {
  return (
    <div className="w-full py-16 px-4">
      <div className="dataprivacy max-w-[1024px] py-8 mx-auto text-justify">
        <h1
          name="datenschutz"
          className="my-4 text-xl uppercase font-bold text-secondary-blue-400"
        >
        ...
        <p>
          ...
          Geschäftsleitung der Windsports Sardinia. Eine Nutzung der
          Internetseiten der Windsports Sardinia ist grundsätzlich ohne jede
        ...
        <p>
          ...
          und in Übereinstimmung mit den für die Windsports Sardinia geltenden
        ...
        <p>
          Die Windsports Sardinia hat als für die Verarbeitung Verantwortlicher
        ...
        <p>
          Die Datenschutzerklärung der Windsports Sardinia beruht auf den
        ...
        <p>Windsports Sardinia</p>
        <p>ASD Viale Sardegna 33b c/o Studio Mulas e Mercuri Associati Nuoro</p>
        <p>08020 Sardinien</p>
        <p>Italien</p>
        <p>Tel.: +49 173 24 30 00 2</p>
        <p>E-Mail: posada@nidosurf.com</p>
        <p>Website: www.surfspiritfun.de</p>

        <h4>3. Erfassung von allgemeinen Daten und Informationen</h4>
        <p>
          Die Internetseite der Windsports Sardinia erfasst mit jedem Aufruf der
        ...
        <p>
          ...
          Windsports Sardinia keine Rückschlüsse auf die betroffene Person.
          ...
          anonym erhobenen Daten und Informationen werden durch die Windsports
          Sardinia daher einerseits statistisch und ferner mit dem Ziel
        ...
        <p>
          Die Internetseite der Windsports Sardinia enthält aufgrund von
        ...
        <ul className="list-none">
          ...
          <li>
            ...
            <p>
              ...
              bei der Windsports Sardinia gespeichert sind, veranlassen möchte,
              kann sie sich hierzu jederzeit an einen Mitarbeiter des für die
              Verarbeitung Verantwortlichen wenden. Der Mitarbeiter der
              Windsports Sardinia wird veranlassen, dass dem Löschverlangen
              unverzüglich nachgekommen wird.
            </p>

            <p>
              Wurden die personenbezogenen Daten von der Windsports Sardinia
              öffentlich gemacht und ist unser Unternehmen als Verantwortlicher
              gemäß Art. 17 Abs. 1 DS-GVO zur Löschung der personenbezogenen
              Daten verpflichtet, so trifft die Windsports Sardinia unter
              ...
              der Windsports Sardinia wird im Einzelfall das Notwendige
              veranlassen.
            </p>
          </li>
          <li>
            ...
            <p>
              ...
              Daten, die bei der Windsports Sardinia gespeichert sind, verlangen
              ...
              Windsports Sardinia wird die Einschränkung der Verarbeitung
              veranlassen.
            </p>
          </li>
          <li>
          ...
          <li>
            ...
            <p>
              Die Windsports Sardinia verarbeitet die personenbezogenen Daten im
            ...
            <p>
              Verarbeitet die Windsports Sardinia personenbezogene Daten, um
              ...
              Person gegenüber der Windsports Sardinia der Verarbeitung für
              Zwecke der Direktwerbung, so wird die Windsports Sardinia die
            ...
            <p>
              ...
              Verarbeitung personenbezogener Daten, die bei der Windsports
              Sardinia zu wissenschaftlichen oder historischen Forschungszwecken
            ...
            <p>
              ...
              Person direkt an jeden Mitarbeiter der Windsports Sardinia oder
          ...
          <li>
            ...
            <p>
              ...
              Windsports Sardinia angemessene Maßnahmen, um die Rechte und
        ...
        <p>
          Entwickelt von den <a href="https://willing-able.com/">Legal Tech</a>{" "}
          Spezialisten von Willing & Able, die auch das System für{" "}
          <a href="https://abletorecords.com/">
            einfache Verfahrensverzeichnisse
          </a>{" "}
